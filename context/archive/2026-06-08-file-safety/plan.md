...
- [x] 3.1 Build passes: `dotnet build` — ee38cbb3
- [x] 3.2 All new containment + parity tests pass: `dotnet test` — ee38cbb3
- [x] 3.3 Removing the guard call from any disk service fails its parity test (spike + restore) — ee38cbb3
- [x] 3.4 Full suite green, no regressions — ee38cbb3

#### Manual

- [x] 3.5 Normal in-workspace create/delete/switch operations work; no false rejections — ee38cbb3
- [x] 3.6 Crafted name (`..`, reserved) shows inline dialog validation error — ee38cbb3
- [x] 3.7 After workspace switch, save/delete confine against the new root — ee38cbb3
