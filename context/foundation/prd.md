...
- FR-009: User can create a new note from a template, filling a form generated from the template's field definitions. Supported field types: text, date, number, and dropdown/select. Priority: must-have
  > Socrates: No counter-argument; stands as written.
